...
import { FigureSpec, FigureRenderError } from './figure_spec.mjs';
import { renderFigure } from './render_product_svg.mjs';
import { scoreFigureSvg, pngMeetsResolution } from './figure_checks.mjs';
